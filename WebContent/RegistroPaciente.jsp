...
<body>
	...
	<form action="CrearPacientesServlet" method="post">
		<p><label for="nsspaciente">NSS: </label> <input class="form-control" type="text" name="nsspaciente"></p>
		<p><label for="nombrepaciente">nombre: </label> <input class="form-control" type="text" name="nombrepaciente"></p>
		<p><label for="apellidopaciente">apellido: </label> <input class="form-control" type="text" name="apellidopaciente"></p>
		<p><label for="nomresponsable">nombre del responsable: </label> <input class="form-control" type="text" name="nomresponsable"></p>
